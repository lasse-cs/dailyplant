"""
Django settings for dailyplant project.
...
WSGI_APPLICATION = "dailyplant.wsgi.application"
...
STATICFILES_DIRS = [PROJECT_DIR / "static", BASE_DIR / "static_built"]
